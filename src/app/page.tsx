...
export default function Home() {
  const [whyChooseUsTypedText, setWhyChooseUsTypedText] = useState(
    Array(5).fill("")
  );
  ...
  const whyChooseUsItems = [
    {
      ...
      description:
        "Our platform tailors the feedback and suggestions to your unique voice and speaking style. No generic advice—everything is customized to help you become the best speaker you can be.",
    },
    {
      title: "Real-Time Feedback",
      description:
        "No more waiting for days or weeks to get feedback on your speech. With our real-time analysis, you can immediately see where you can improve and start working on it right away.",
    },
    {
      title: "Easy to Use",
      description:
        "We've made sure our platform is user-friendly and intuitive, so you can focus on what really matters—improving your speech. Just speak, analyze, and improve, all in a few simple steps.",
    },
    {
      title: "Cutting-Edge Technology",
      description:
        "We leverage the latest advancements in AI and voice technology to provide you with accurate, insightful, and actionable feedback. Our voice cloning feature ensures you hear the best version of yourself, pushing you towards continuous improvement.",
    },
    {
      title: "Support Anytime, Anywhere",
      description:
        "Whether you're at home, in the office, or on the go, our platform is accessible from any device. Plus, with our chatbot ready to answer your questions, you're never alone on your journey to better communication.",
    },
  ];
      ...
      <div className="relative z-10 min-h-screen">
        ...
        <header className="absolute top-0 left-0 right-0 z-50 flex justify-between items-center p-8">
          <div className="text-4xl font-bold text-white">
            audibly<span className="text-purple-500">.</span>
          </div>
          ...
          titleComponent={
            <>
              <h1 className="text-4xl font-semibold text-white">
                Elevate Your Speaking Skills with <br />
                ...
                >
                  <Card className="bg-neutral-800 border-neutral-700">
                    <CardContent className="p-4">
                      ...
                      <p className="text-neutral-300 h-20 text-sm">
                        {item.description}
                      </p>
                    </CardContent>
                  </Card>
